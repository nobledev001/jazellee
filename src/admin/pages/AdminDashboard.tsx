...
import { ShoppingCart, DollarSign, Package, ArrowUpRight, AlertTriangle, RefreshCw, Users, Bell, Clock } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-1">
            Welcome back. Customer orders, registrations, and inventory overview.
          </p>
        </div>
