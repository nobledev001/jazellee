  ...
  return (
    <section className="container-jazelle py-14 sm:py-20">
      <div className="text-center mb-8">
        ...
        <h2 className="section-title mt-2">Follow the Haven</h2>
        <p className="text-berry-400 text-sm sm:text-base mt-2 max-w-md mx-auto">
          Self-care tips, behind-the-scenes, and little reminders to take
          care of you — join our community.
        </p>
      </div>
      ...
      <div className="flex justify-center mb-8">
        <a
          href="https://instagram.com/jazelle.skin.haven"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2.5 px-5 py-3 rounded-full bg-white shadow-soft text-berry-700 font-medium text-sm hover:shadow-soft-lg transition-shadow"
        >
